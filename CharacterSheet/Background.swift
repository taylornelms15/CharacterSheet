...
class Background: NSManagedObject {
    ...
    static func backgroundInit(context: NSManagedObjectContext){
        ...
        backgroundFeature1.setValue("\tYou may take advantage of free healing and care at temples and shrines of your faith. You may also call upon priests of your temple for assistance.", forKey: "details")
