...
class Feat: Feature {
    ...
    static func featsInit(context: NSManagedObjectContext){
        ...
        feat6.setValue("\tWhen wielding a finesse weapon with which you are proficient and another creature hits you with a melee attack, you may use your reaction to add your proficiency bonus to your AC for that attack.\n\tTaking this requires a Dexterity of 13 or higher.", forKey: "details")
        ...
        feat18.setValue("\tIncrease your Strength score by 1. You gain proficiency with heavy armor.\n\tTaking this feat requires proficiency with medium armor.", forKey: "details")
        ...
        feat19.setValue("\tIncrease your Strength score by 1. Additionally, while wearing heavy armor, non-magical bludgeoning, piercing, and slashing damage is reduced by 3.\n\tTaking this feat requires proficiency with heavy armor.", forKey: "details")
        ...
        feat20.setValue("\tYou may spend 10 minutes inspiring your companions, affecting up to 6 friendly creatures within 30 feet of you. Each gains temporary hit points equal to your level + your Charisma modifier. The creature can only benefit from this feat once per short or long rest.\n\tTaking this requires a Charisma of 13 or higher.", forKey: "details")
        ...
        feat28.setValue("\tWearning medium armor doesn't impose disadvantage on your Stealth checks. Additionally, when wearing medium armor, you can add 3 to your AC rather than 2, if you have a Dexterity of 16 or higher./n/tTaking this feat requires proficiency with medium armor.", forKey: "details")
        ...
        feat30.setValue("\tIncrease your Strength or Dexterity score by 1. You gain proficiency with medium armor and shields.\n\tTaking this feat requires proficiency with light armor.", forKey: "details")
        ...
        feat41.setValue("\tYou may try to hide when lightly obscured. When you are hidden from a creature and miss it with a ranged weapon attack, the attack does not reveal your position. Additionally, dim light doesn't impose disadvantage on your Perception checks.\n\tTaking this requires a Dexterity of 13 or higher.", forKey: "details")
